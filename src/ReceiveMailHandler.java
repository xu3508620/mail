...
public class ReceiveMailHandler {
    ...
    public void receiveMail(String userName,String passWord) {
        ...
        try{
            ...
            store = (IMAPStore)getSessionMail().getStore(urln);
            store.connect();
            ...
            if(messageCount > 0){
                ...
                System.out.println("主题: " + getSubject(messages[0]));
                System.out.println("发送时间: " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(((MimeMessage) messages[0]).getSentDate()));
                IMAPMessage message = (IMAPMessage)messages[0];
                message.setFlag(Flags.Flag.DELETED,true);
                System.out.println("删除结果:"+message.isSet(Flags.Flag.DELETED));
    ...
    private String getMailContent(Part part) throws Exception {
        ...
        if (part.isMimeType("text/plain")) {
            ...
            bodytext.append(part.getDataHandler().getContentType());
        }
